...
/// GPT-2 BPE tokenizer (pretrained vocab via the `tokenizers` crate), used by
/// the real training pipeline. Kept separate from the from-scratch `Tokenizer`
/// below, which existing examples (train_dashboard, tokenizer_test) still rely on.
